...
function edtvalidation() {
	...
	/*var ofn=document.getElementById("leadingofficername").value
	var ofnletters=/^[a-zA-Z]+[a-zA-Z]+$/;*/
	
	var addof=document.getElementById("officeaddress").value
	var addofletters=/^[a-zA-Z0-9\s\,\''\-]*$/;
...
<body>
<div class="content">
      <form action="admin_home_page.jsp"method=""onsubmit="return edtvalidation()">
